...
![GitHub](https://img.shields.io/github/license/viafintech/cronlocker) [![Build Status](https://travis-ci.org/viafintech/cronlocker.svg?branch=master)](https://travis-ci.org/viafintech/cronlocker) ![GitHub go.mod Go version](https://img.shields.io/github/go-mod/go-version/viafintech/cronlocker) ![GitHub release (latest by date)](https://img.shields.io/github/v/release/viafintech/cronlocker)
